...
f = file("/Users/alex/Desktop/Diploma/ag_1_GGCTAC_filtered.fastq", "r")
...
o_res = []
f = open("/Users/alex/Desktop/Diploma/results_Oases.txt", "r")
o_res = pickle.load(f)
f.close()

t_res = []
f = open("/Users/alex/Desktop/Diploma/results_Trinity.txt", "r")
t_res = pickle.load(f)
f.close()

#################    READS FOR OASES     #####################

f = file("/Users/alex/Desktop/Diploma/results_oases.sam", "r")
...
#####################       READS FOR TRINITY      #######################
f = file("/Users/alex/Desktop/Diploma/results_trinity.sam", "r")
...
f = open("/Users/alex/Desktop/Diploma/ref_for_reads.fasta", "r")
ref = []
...
f = open("/Users/alex/Desktop/Diploma/Oases.fasta", "r")
oases = []
o_name_index = []
...
f = open("/Users/alex/Desktop/Diploma/Trinity.fasta", "r")
trinity = []
t_name_index = []
...
f = open("/Users/alex/Desktop/Diploma/Levenshtein_for_Oases.txt", "r")
o_dist = pickle.load(f)
f.close()

t_dist = np.zeros([len(ref), len(trinity)])
f = open("/Users/alex/Desktop/Diploma/Levenshtein_for_Trinity.txt", "r")
t_dist = pickle.load(f)
f.close()

o_pairs = np.array(range(len(ref)))
f = open("/Users/alex/Desktop/Diploma/Similar_transkripts_Oases.txt", "r")
o_pairs = pickle.load(f)
f.close()

t_pairs = np.array(range(len(ref)))
f = open("/Users/alex/Desktop/Diploma/Similar_transkripts_Trinity.txt", "r")
...
'''
f = file("/Users/alex/Desktop/Diploma/Class_Trinity.txt", "w")
